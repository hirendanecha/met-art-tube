...
export function app(): express.Express {
  ...
  const distFolder = join(process.cwd(), 'tube-dist/video-metart-tube/browser');
  ...
  const template = fs
    .readFileSync(
      path.join(join(process.cwd(), 'tube-dist/video-metart-tube/browser'), 'index.html')
    )
    .toString();
    ...
    res.render(
      ...
      async (err, html) => {
        ...
        var seo: any = {
          ...
          image:
            'https://video.metart.tube/assets/meta.png',
          site: 'https://video.metart.tube/',
          url: 'https://video.metart.tube' + params,
          keywords: 'video.MetArt.tube',
        };
        if (
          ...
          const talent = {
            name: post?.title || post?.albumname || 'MetArt.tube Post',
            description: pdhtml?.textContent || 'Post content',
            image: post?.thumbfilename || post?.metaimage || post?.imageUrl || 'https://video.metart.tube/assets/meta.png',
          };
          seo.title = talent.name;
          seo.description = strip_html_tags(talent.description);
          seo.image = talent.image;
